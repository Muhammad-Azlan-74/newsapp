        ...
        children: [
          ...
          if (_showHelpLabels)
            Positioned(
              ...
              child: _buildHelpLabel('HOF Friends', onTap: _showHofFriendsDialog),
            ),
          ...
          if (_showHelpLabels)
            Positioned(
              ...
              child: _buildHelpLabel('Personal HOF', onTap: () => Navigator.pushNamed(context, AppRoutes.personalHof)),
            ),
          // Top stats strip
          const TopStatsStrip(),
        ],
